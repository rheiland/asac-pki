...
public class PubKeyState extends State {
    ...
    protected Map<String, Map<String, PubKeyRing>> keys = new LinkedHashMap<String, Map<String, PubKeyRing>>();
    ...
    public class PubKeyRing {
        ...
        public PubKeyRing(boolean r, boolean w, Integer v) {
            read = r;
            write = w;
    ...
    public static final Property filesProperty = new Property(PubKeyState.class, "files");
    public static final Property keysProperty = new Property(PubKeyState.class, "keys");
    public static final Property roleKeysProperty = new Property(PubKeyState.class, "roleKeys");
    public static final Property sizeofProperty = new Property(PubKeyState.class, "sizeof");
    ...
    int getKeysSize() {
        // asym-encrypted symmetric keys: file -> (role -> rw, versions)
        // Map<String, Map<String, PubKeyRing>> keys
        int ret = 0;
    ...
    public void addKey(String f, String i, boolean r, boolean w, int v) {
        ...
        if(!keys.containsKey(f)) {
            keys.put(f, new LinkedHashMap<String, PubKeyRing>());
        }
        if(!keys.get(f).containsKey(i)) {
            keys.get(f).put(i, new PubKeyRing(r, w, v));
        } else {
            PubKeyRing kr = keys.get(f).get(i);
            kr.read = kr.read || r;
            kr.write = kr.write || w;
            kr.versions.add(v);
        }
