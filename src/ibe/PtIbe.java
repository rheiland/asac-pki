...
public class PtIbe extends Scheme {
    ...
    public PtIbe(State initState) {
        super(initState);

        if(!(initState instanceof PtIbeState)) {
    ...
    public static final Property lastStateProperty = new Property(PtIbe.class, Scheme.Q_LASTSTATE, new String[0]);
    ...
    private void command(Action acAction) {
        PtIbeState iState = (PtIbeState) state;
