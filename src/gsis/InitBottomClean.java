...
public class InitBottomClean extends SimulationStarter implements Serializable {
	/**
	 *
	 */
	...
	public InitBottomClean(int numManagers, int numPosters, int numConsumers) {
