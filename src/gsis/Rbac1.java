 ...
 *
 */
public class Rbac1 extends WorkloadScheme {

	public Rbac1(WorkloadState initState) {
		super(initState);
	}
	...
	public void query(Action acAction) {
		...
		case "RH": {
			IAccessW<RbacState.RolePair> RH = rState.getRH();
	...
	public Action addParameters(Action a, Workflow w) {
		...
		//Not needed for this simulaion since we're using this as a bridge.
		return null;
	}
