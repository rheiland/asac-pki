...
public class InitPiClean extends SimulationStarter implements Serializable {
	/**
	 *
	 */
	...
	public InitPiClean(int numManagers, int numPosters, int numConsumers) {
