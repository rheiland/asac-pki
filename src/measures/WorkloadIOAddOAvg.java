...
public class WorkloadIOAddOAvg extends Measure {
	Measure io = new WorkloadIOAddO();
	Measure instances = new InstancesAddO();

	public WorkloadIOAddOAvg() {
		curMeasurement = new DoubleReplaceCost();
	}

	@Override
	public String getMeasureName() {
		return "Workload_IO_addO_Avg";
	}

	@Override
	public String getPrintFriendlyName() {
		return "Average workload I/O for addO operations";
	}
