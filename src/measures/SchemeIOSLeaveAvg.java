...
public class SchemeIOSLeaveAvg extends Measure {
	Measure io = new SchemeIOSLeave();
	Measure instances = new InstancesSLeave();

	public SchemeIOSLeaveAvg() {
		curMeasurement = new DoubleReplaceCost();
	}

	@Override
	public String getMeasureName() {
		return "Scheme_IO_SLeave_Avg";
	}

	@Override
	public String getPrintFriendlyName() {
		return "Average scheme I/O per SLeave operation";
	}
