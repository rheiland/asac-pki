...
public class WorkloadIOLLeaveAvg extends Measure {
	Measure io = new WorkloadIOLLeave();
	Measure instances = new InstancesLLeave();

	public WorkloadIOLLeaveAvg() {
		curMeasurement = new DoubleReplaceCost();
	}

	@Override
	public String getMeasureName() {
		return "Workload_IO_LLeave_Avg";
	}

	@Override
	public String getPrintFriendlyName() {
		return "Average workload I/O for LLeave operations";
	}
