...
public class WorkloadIOSLeaveAvg extends Measure {
	Measure io = new WorkloadIOSLeave();
	Measure instances = new InstancesSLeave();

	public WorkloadIOSLeaveAvg() {
		curMeasurement = new DoubleReplaceCost();
	}

	@Override
	public String getMeasureName() {
		return "Workload_IO_SLeave_Avg";
	}

	@Override
	public String getPrintFriendlyName() {
		return "Average workload I/O for SLeave operations";
	}
