...
//public class PtIbe extends Scheme {
public class Model1 extends Scheme {

    public Model1(State initState) {
        super(initState);

        if(!(initState instanceof Model1State)) {
    ...
    public static final Property lastStateProperty = new Property(Model1.class, Scheme.Q_LASTSTATE, new String[0]);
    ...
    private void command(Action acAction) {
        Model1State iState = (Model1State) state;
