...
public class ActorCertAuth extends ActorMachine {
    double addBias = 0.5;
    double urBias = 0.5;

    public static final ActorProperty sentinelProperty = new ActorProperty(ActorCertAuth.class, Q_TIME);
...
//        double thresholdManageUr = 0.1 * Math.sqrt(((ibe.Rbac0WState)sys.impl.wScheme.state).U.size())
        double thresholdManageUr = 0.1 * Math.sqrt(((web.PkiWState)sys.impl.wScheme.state).U.size())
                / (1 * Conversion.Days);
        ...
        Log.d("ActorCertAuth coin: " + coin + ". Thresholds: " +
                thresholdManageU + " " +
                thresholdManageR + " " +
                thresholdManageP + " " +
                thresholdManageUr + " " +
